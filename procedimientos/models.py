...
# =========================================================
class ProcedimientosDB(models.Model):
    ...
    # NUEVO CAMPO: Archivo PDF del procedimiento actual
    ...
    def __str__(self):
        return f"Cod. Proced. {self.cod_procedimiento}"


# =========================================================
# MODELO: HISTÓRICO DE PROCEIMIENTOS (ADAPTADO)
# =========================================================
class ProcedimientosHistoricoDB(models.Model):
    procedimiento = models.ForeignKey(
        ProcedimientosDB,
        on_delete=models.PROTECT,  # Se cambia a PROTECT para preservar el histórico aunque se borre el procedimiento
        related_name='historicos',
        verbose_name='Procedimiento'
    )
    
    cod_procedimiento = models.CharField(blank=True, null=True, max_length=20, verbose_name='Código Procedimiento')
    ...
    def __str__(self):
        return f"Histórico Procedimiento {self.procedimiento_id} - Ver: {self.version or 'S/V'}"