...
# =========================================================
# MODELO PRINCIPAL: PROCEIMIENTOS
# =========================================================
class FormulariosDB(models.Model):
    ...
    cod_formulario = models.CharField(max_length=20, verbose_name='Código Formulario')
    ...
    # NUEVO CAMPO: Archivo PDF del formulario actual
    ...
    def __str__(self):
        return f"Cod. Formulario {self.cod_formulario}"


# =========================================================
# MODELO: HISTÓRICO DE PROCEIMIENTOS (ADAPTADO)
# =========================================================
class FormulariosHistoricoDB(models.Model):
    formulario = models.ForeignKey(
        FormulariosDB,
        on_delete=models.PROTECT,  # Se cambia a PROTECT para preservar el histórico aunque se borre el formulario
        related_name='historicos',
        verbose_name='Formulario'
    )
    
    cod_formulario = models.CharField(blank=True, null=True, max_length=20, verbose_name='Código Formulario')
    ...
    class Meta:
        ...
        verbose_name_plural = 'Historial de Formularios'
        ordering = ['-fecha_aprobacion', 'formulario']
        
    def __str__(self):
        return f"Histórico Formulario {self.formulario_id} - Ver: {self.version or 'S/V'}"